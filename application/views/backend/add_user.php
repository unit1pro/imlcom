                    ...
                    <div class="x_content">
                        ...
                        <form id="song_add_form" method="post" action="<?php echo site_url('User/edit') ?>" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="DOB" name="dob" value="<?php echo isset($formdata[0]['DOB']) && !empty($formdata[0]['DOB']) ? $formdata[0]['DOB'] : ''; ?>" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="DOJ" name="doj" value="<?php echo isset($formdata[0]['DateJoined']) && !empty($formdata[0]['DateJoined']) ? $formdata[0]['DateJoined'] : ''; ?>" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div class="form-group">
