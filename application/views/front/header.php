    ...
    <header>
            ...
            <div class="layout-row header-wrapper">
                <div class="flex-15 flex-xs-10">
                    <img src="<?php echo base_url() ?>front/img/logo-white.png" alt="logo" height="76"/>
                </div>
                <div class="flex-70 flex-xs-60 layout-align-center-end layout-row">
                    <img src="<?php echo base_url() ?>front/img/title.png" alt="tile"/>
                </div>
                <div class="layout-row flex-15 flex-xs-30 layout-align-end-start link-wrapper">
